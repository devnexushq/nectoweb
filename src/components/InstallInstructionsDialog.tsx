    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Add Necto to your home screen for an app-like experience.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4 text-sm">
          ...
          {!ios && !android && (
            <Section title="Desktop (Chrome / Edge)">
              <ol className="list-decimal pl-5 space-y-1">
                ...
                <li>
                  Or open the browser menu and choose <strong>Install Necto</strong>.
                </li>
                <li>
                  Confirm <strong>Install</strong>.
                </li>
          ...
          {!ios && !android && browser === "firefox" && (
            <Section title="Firefox">
              <p>
                Firefox on desktop does not support installable PWAs. Use Chrome or Edge for
                installation.
              </p>
            </Section>
          )}
