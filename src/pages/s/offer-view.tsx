          ...
          <article className="rounded-3xl border border-border bg-white p-5 shadow-sm">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="rounded-full bg-muted px-3 py-1 text-xs font-bold text-muted-foreground">
                {offer.visibility_scope}
              </span>
            </div>
            <h1 className="mt-4 text-2xl font-black text-foreground">{offer.title}</h1>
            {offer.discount_text && (
              <p className="mt-2 inline-flex rounded-xl bg-emerald-50 px-3 py-2 text-sm font-bold text-emerald-700">
                {offer.discount_text}
              </p>
            )}
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              <Link
                ...
                className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-primary font-bold text-white hover:bg-primary/90"
              >
              ...
              <Link
                to="/s/offers"
                className="inline-flex h-11 items-center justify-center rounded-xl border border-border font-bold hover:bg-muted"
              >
                Back to Offers
              </Link>
            </div>
